// nem v0.1.0 2f6c2d543607e874bfa96053a7eb6ab25ca9da80
// --
...
func WebRPCSchemaHash() string {
	return "2f6c2d543607e874bfa96053a7eb6ab25ca9da80"
}
...
type TeacherServiceAPI interface {
	...
	UpdateAvailability(ctx context.Context, id string, startAt time.Time, endAt time.Time) (*TimeSlot, error)
...
func (s *teacherServiceAPIServer) serveUpdateAvailabilityJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.TeacherServiceAPI.UpdateAvailability(ctx, reqContent.Arg0, reqContent.Arg1, reqContent.Arg2)
	}()
	respContent := struct {
		Ret0 *TimeSlot `json:"timeSlot"`
	}{ret0}
