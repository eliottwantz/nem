// nem v0.1.0 647c315556778fdef368a7ad3360d14a227ff3e9
// --
...
func WebRPCSchemaHash() string {
	return "647c315556778fdef368a7ad3360d14a227ff3e9"
}
...
func (s *teacherServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/TeacherServiceAPI/ListClassesOfTeacher":
		s.serveListClassesOfTeacher(ctx, w, r)
		return
	case "/rpc/TeacherServiceAPI/ListStudentsOfTeacher":
		s.serveListStudentsOfTeacher(ctx, w, r)
		return
	case "/rpc/TeacherServiceAPI/FindStudentOfTeacher":
		s.serveFindStudentOfTeacher(ctx, w, r)
		return
...
func (s *teacherServiceAPIServer) serveListClassesOfTeacher(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListClassesOfTeacherJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *teacherServiceAPIServer) serveListClassesOfTeacherJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.TeacherServiceAPI.ListClassesOfTeacher(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 []*Class `json:"classes"`
	}{ret0}
...
func (s *teacherServiceAPIServer) serveListStudentsOfTeacher(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListStudentsOfTeacherJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *teacherServiceAPIServer) serveListStudentsOfTeacherJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.TeacherServiceAPI.ListStudentsOfTeacher(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *teacherServiceAPIServer) serveFindStudentOfTeacher(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFindStudentOfTeacherJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *teacherServiceAPIServer) serveFindStudentOfTeacherJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.TeacherServiceAPI.FindStudentOfTeacher(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
...
func (s *messageServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/MessageServiceAPI/CreateOneToOneConversation":
		s.serveCreateOneToOneConversation(ctx, w, r)
		return
...
func (s *messageServiceAPIServer) serveCreateOneToOneConversation(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveCreateOneToOneConversationJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *messageServiceAPIServer) serveCreateOneToOneConversationJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.MessageServiceAPI.CreateOneToOneConversation(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *messageServiceAPIServer) serveSendMessageToUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		err = s.MessageServiceAPI.SendMessageToUser(ctx, reqContent.Arg0)
	}()
...
func (s *messageServiceAPIServer) serveFindConversationById(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFindConversationByIdJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *messageServiceAPIServer) serveFindConversationByIdJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.MessageServiceAPI.FindConversationById(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *messageServiceAPIServer) serveFindOneToOneConversation(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveFindOneToOneConversationJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *messageServiceAPIServer) serveFindOneToOneConversationJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.MessageServiceAPI.FindOneToOneConversation(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
		Ret0 *Conversation `json:"conversation"`
	}{ret0}
...
func (s *messageServiceAPIServer) serveListConversationsOfUser(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListConversationsOfUserJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *messageServiceAPIServer) serveListConversationsOfUserJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.MessageServiceAPI.ListConversationsOfUser(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *messageServiceAPIServer) serveListMessagesOfConversation(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListMessagesOfConversationJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *messageServiceAPIServer) serveListMessagesOfConversationJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.MessageServiceAPI.ListMessagesOfConversation(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *messageServiceAPIServer) serveListMessagesOfConversationWithCursor(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListMessagesOfConversationWithCursorJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *messageServiceAPIServer) serveListMessagesOfConversationWithCursorJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, ret1, err = s.MessageServiceAPI.ListMessagesOfConversationWithCursor(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
		Ret0 []*Message `json:"messages"`
