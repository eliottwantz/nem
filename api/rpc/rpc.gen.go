...
func WebRPCSchemaHash() string {
	return "e4156003d5aa09d4474ef294082c7a4ed6fd655c"
}
...
type PublicServiceAPI interface {
	...
	AddHoursToHoursBank(ctx context.Context, studentId string, teacherId string, hours int32) error
}

type UserServiceAPI interface {
	Get(ctx context.Context) (*User, error)
	FindUserByID(ctx context.Context, id string) (*User, error)
	ListTeachers(ctx context.Context, filters *ListTeachersFilters) ([]*ListTeacher, error)
	TeachersCount(ctx context.Context) (int64, error)
	ListTopicsTaught(ctx context.Context) ([]*Topic, error)
	ListLanguagesTaught(ctx context.Context) ([]string, error)
...
type StudentServiceAPI interface {
	...
	GetHoursBankForTeacher(ctx context.Context, teacherId string) (int32, error)
	ListAvailabilitiesOfTeacher(ctx context.Context, teacherId string) ([]*TimeSlot, error)
	CancelClass(ctx context.Context, classId string) error
}
...
type SubscriptionServiceAPI interface {
	...
	AddSubscriptionForStudent(ctx context.Context, studentId string, teacherId string, subscriptionId string) error
}
...
var WebRPCServices = map[string][]string{
	...
	"StudentServiceAPI": {
		...
		"GetHoursBankForTeacher",
		"ListAvailabilitiesOfTeacher",
		"CancelClass",
	},
	"TeacherServiceAPI": {
		"FindTeacherByID",
...
func (s *publicServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/PublicServiceAPI/AddHoursToHoursBank":
		handler = s.serveAddHoursToHoursBankJSON
	default:
...
func (s *publicServiceAPIServer) serveAddHoursToHoursBankJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AddHoursToHoursBank")
	...
	// Call service method implementation.
	err = s.PublicServiceAPI.AddHoursToHoursBank(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *userServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/UserServiceAPI/TeachersCount":
		handler = s.serveTeachersCountJSON
	case "/rpc/UserServiceAPI/ListTopicsTaught":
		handler = s.serveListTopicsTaughtJSON
	case "/rpc/UserServiceAPI/ListLanguagesTaught":
		handler = s.serveListLanguagesTaughtJSON
...
func (s *userServiceAPIServer) serveListTeachersJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	respPayload := struct {
		Ret0 []*ListTeacher `json:"teachers"`
	}{ret0}
	respBody, err := json.Marshal(respPayload)
	if err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadResponse.WithCause(fmt.Errorf("failed to marshal json response: %w", err)))
...
func (s *userServiceAPIServer) serveTeachersCountJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "TeachersCount")

	// Call service method implementation.
	ret0, err := s.UserServiceAPI.TeachersCount(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *userServiceAPIServer) serveListTopicsTaughtJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListTopicsTaught")

	// Call service method implementation.
	ret0, err := s.UserServiceAPI.ListTopicsTaught(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *userServiceAPIServer) serveListLanguagesTaughtJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListLanguagesTaught")

	// Call service method implementation.
	ret0, err := s.UserServiceAPI.ListLanguagesTaught(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *studentServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/StudentServiceAPI/GetHoursBankForTeacher":
		handler = s.serveGetHoursBankForTeacherJSON
	case "/rpc/StudentServiceAPI/ListAvailabilitiesOfTeacher":
		handler = s.serveListAvailabilitiesOfTeacherJSON
	case "/rpc/StudentServiceAPI/CancelClass":
...
func (s *studentServiceAPIServer) serveGetHoursBankForTeacherJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetHoursBankForTeacher")
	...
	// Call service method implementation.
	ret0, err := s.StudentServiceAPI.GetHoursBankForTeacher(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *studentServiceAPIServer) serveListAvailabilitiesOfTeacherJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListAvailabilitiesOfTeacher")
	...
	// Call service method implementation.
	ret0, err := s.StudentServiceAPI.ListAvailabilitiesOfTeacher(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *studentServiceAPIServer) serveCancelClassJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	// Call service method implementation.
	err = s.StudentServiceAPI.CancelClass(ctx, reqPayload.Arg0)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
type subscriptionServiceAPIServer struct {
	SubscriptionServiceAPI
	OnError func(r *http.Request, rpcErr *WebRPCError)
}

func NewSubscriptionServiceAPIServer(svc SubscriptionServiceAPI) *subscriptionServiceAPIServer {
	return &subscriptionServiceAPIServer{
		SubscriptionServiceAPI: svc,
	}
}

func (s *subscriptionServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	defer func() {
		// In case of a panic, serve a HTTP 500 error and then panic.
		if rr := recover(); rr != nil {
			s.sendErrorJSON(w, r, ErrWebrpcServerPanic.WithCause(fmt.Errorf("%v", rr)))
	...
	ctx = context.WithValue(ctx, HTTPResponseWriterCtxKey, w)
	ctx = context.WithValue(ctx, HTTPRequestCtxKey, r)
	ctx = context.WithValue(ctx, ServiceNameCtxKey, "SubscriptionServiceAPI")

	var handler func(ctx context.Context, w http.ResponseWriter, r *http.Request)
	switch r.URL.Path {
	case "/rpc/SubscriptionServiceAPI/ListSubscriptions":
		handler = s.serveListSubscriptionsJSON
	case "/rpc/SubscriptionServiceAPI/AddSubscriptionForStudent":
		handler = s.serveAddSubscriptionForStudentJSON
	default:
		err := ErrWebrpcBadRoute.WithCause(fmt.Errorf("no handler for path %q", r.URL.Path))
		s.sendErrorJSON(w, r, err)
		return
...
func (s *subscriptionServiceAPIServer) serveListSubscriptionsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListSubscriptions")

	// Call service method implementation.
	ret0, err := s.SubscriptionServiceAPI.ListSubscriptions(ctx)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
	...
	respPayload := struct {
		Ret0 []*Subscription `json:"subscriptions"`
	}{ret0}
	respBody, err := json.Marshal(respPayload)
	if err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadResponse.WithCause(fmt.Errorf("failed to marshal json response: %w", err)))
...
func (s *subscriptionServiceAPIServer) serveAddSubscriptionForStudentJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	ctx = context.WithValue(ctx, MethodNameCtxKey, "AddSubscriptionForStudent")
	...
	reqPayload := struct {
		Arg0 string `json:"studentId"`
		Arg1 string `json:"teacherId"`
		Arg2 string `json:"subscriptionId"`
	}{}
	if err := json.Unmarshal(reqBody, &reqPayload); err != nil {
		s.sendErrorJSON(w, r, ErrWebrpcBadRequest.WithCause(fmt.Errorf("failed to unmarshal request data: %w", err)))
		return
	...
	// Call service method implementation.
	err = s.SubscriptionServiceAPI.AddSubscriptionForStudent(ctx, reqPayload.Arg0, reqPayload.Arg1, reqPayload.Arg2)
	if err != nil {
		rpcErr, ok := err.(WebRPCError)
		if !ok {
			rpcErr = ErrWebrpcEndpoint.WithCause(err)
...
func (s *subscriptionServiceAPIServer) sendErrorJSON(w http.ResponseWriter, r *http.Request, rpcErr WebRPCError) {
	if s.OnError != nil {
		s.OnError(r, &rpcErr)
	}
