// nem v0.1.0 73b9eef2f1b64148b636d98e4e6ba873fa383ddd
// --
...
func WebRPCSchemaHash() string {
	return "73b9eef2f1b64148b636d98e4e6ba873fa383ddd"
}
...
type AdminCreateClassRequest struct {
	...
	TopicTaughtId int32    `json:"topicTaughtId"`
...
type TeacherServiceAPI interface {
	...
	ListTopicsTaught(ctx context.Context) ([]*TopicTaught, error)
	Teach(ctx context.Context, language string, topic string) (*TopicTaught, error)
	ListAvailabilities(ctx context.Context) ([]*TimeSlot, error)
...
type ClassServiceAPI interface {
	...
	ListAvailableTopicsTaught(ctx context.Context) ([]*TopicTaught, error)
	ListTeachersForTopicTaught(ctx context.Context, lang string, topic string) ([]*Teacher, error)
	ListTopicsTaughtOfTeacher(ctx context.Context, teacherId string) ([]*TopicTaught, error)
	ListTeacherAvailabilities(ctx context.Context, teacherId string) ([]*TimeSlot, error)
...
var WebRPCServices = map[string][]string{
	...
	"ClassServiceAPI": {
		"ListLanguages",
		"ListTopics",
		"ListAvailableTopicsTaught",
		"ListTeachersForTopicTaught",
		"ListTopicsTaughtOfTeacher",
...
func (s *userServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/UserServiceAPI/FindUserByID":
		...
		return
	case "/rpc/UserServiceAPI/FindTeacherByID":
...
func (s *userServiceAPIServer) serveFindTeacherByID(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *userServiceAPIServer) serveFindTeacherByIDJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.UserServiceAPI.FindTeacherByID(ctx, reqContent.Arg0)
	}()
	respContent := struct {
...
func (s *studentServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/StudentServiceAPI/ListClasses":
		...
		return
	case "/rpc/StudentServiceAPI/ListTeachers":
...
func (s *studentServiceAPIServer) serveListTeachers(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *studentServiceAPIServer) serveListTeachersJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	...
	func() {
		...
		ret0, err = s.StudentServiceAPI.ListTeachers(ctx)
	}()
	respContent := struct {
...
func (s *teacherServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/TeacherServiceAPI/ListStudents":
		...
		return
	case "/rpc/TeacherServiceAPI/ListTopicsTaught":
		s.serveListTopicsTaught(ctx, w, r)
		return
...
func (s *teacherServiceAPIServer) serveListStudentsJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.TeacherServiceAPI.ListStudents(ctx)
	}()
	respContent := struct {
...
func (s *teacherServiceAPIServer) serveListTopicsTaught(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListTopicsTaughtJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *teacherServiceAPIServer) serveListTopicsTaughtJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListTopicsTaught")

	// Call service method
	var ret0 []*TopicTaught
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if rr := recover(); rr != nil {
		...
		ret0, err = s.TeacherServiceAPI.ListTopicsTaught(ctx)
	}()
	respContent := struct {
		Ret0 []*TopicTaught `json:"topicsTaught"`
	}{ret0}
...
func (s *teacherServiceAPIServer) serveTeachJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	respContent := struct {
		Ret0 *TopicTaught `json:"topicTaught"`
	}{ret0}
...
func (s *classServiceAPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/ClassServiceAPI/ListTopics":
		...
		return
	case "/rpc/ClassServiceAPI/ListAvailableTopicsTaught":
		s.serveListAvailableTopicsTaught(ctx, w, r)
		return
	case "/rpc/ClassServiceAPI/ListTeachersForTopicTaught":
		s.serveListTeachersForTopicTaught(ctx, w, r)
		return
	case "/rpc/ClassServiceAPI/ListTopicsTaughtOfTeacher":
		s.serveListTopicsTaughtOfTeacher(ctx, w, r)
		return
	case "/rpc/ClassServiceAPI/ListTeacherAvailabilities":
		s.serveListTeacherAvailabilities(ctx, w, r)
		return
...
func (s *classServiceAPIServer) serveListAvailableTopicsTaught(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListAvailableTopicsTaughtJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *classServiceAPIServer) serveListAvailableTopicsTaughtJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListAvailableTopicsTaught")
	...
	func() {
		...
		ret0, err = s.ClassServiceAPI.ListAvailableTopicsTaught(ctx)
	}()
	respContent := struct {
		Ret0 []*TopicTaught `json:"topicsTaught"`
	}{ret0}
...
func (s *classServiceAPIServer) serveListTeachersForTopicTaught(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListTeachersForTopicTaughtJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *classServiceAPIServer) serveListTeachersForTopicTaughtJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListTeachersForTopicTaught")
	reqContent := struct {
		Arg0 string `json:"lang"`
		Arg1 string `json:"topic"`
	}{}
	...
	func() {
		...
		ret0, err = s.ClassServiceAPI.ListTeachersForTopicTaught(ctx, reqContent.Arg0, reqContent.Arg1)
	}()
	respContent := struct {
		Ret0 []*Teacher `json:"teachers"`
	}{ret0}
...
func (s *classServiceAPIServer) serveListTopicsTaughtOfTeacher(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListTopicsTaughtOfTeacherJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *classServiceAPIServer) serveListTopicsTaughtOfTeacherJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "ListTopicsTaughtOfTeacher")
	reqContent := struct {
	...
	func() {
		...
		ret0, err = s.ClassServiceAPI.ListTopicsTaughtOfTeacher(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 []*TopicTaught `json:"topicsTaught"`
	}{ret0}
...
func (s *classServiceAPIServer) serveListTeacherAvailabilities(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveListTeacherAvailabilitiesJSON(ctx, w, r)
	default:
		err := ErrorWithCause(ErrWebrpcBadRequest, fmt.Errorf("unexpected Content-Type: %q", r.Header.Get("Content-Type")))
		RespondWithError(w, err)
	}
...
func (s *classServiceAPIServer) serveListTeacherAvailabilitiesJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	func() {
		...
		ret0, err = s.ClassServiceAPI.ListTeacherAvailabilities(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 []*TimeSlot `json:"timeSlots"`
	}{ret0}
