...
export const WebRPCSchemaHash = "8ac0e49e451696db00e9cd631ee63548b0fd6a4e"
...
export interface Teacher {
  ...
  topicsTaught: Array<TopicTaught>
  createdAt: string
  updatedAt: string
}
...
export interface StudentServiceAPI {
  ...
  listTeachers(headers?: object, signal?: AbortSignal): Promise<ListTeachersReturn>
...
export interface TeacherServiceAPI {
  listClasses(headers?: object, signal?: AbortSignal): Promise<ListClassesReturn>
  listStudents(headers?: object, signal?: AbortSignal): Promise<ListStudentsReturn>
  ...
  listAvailabilities(headers?: object, signal?: AbortSignal): Promise<ListAvailabilitiesReturn>
...
export interface ClassServiceAPI {
  ...
  listAvailableTopicsTaught(headers?: object, signal?: AbortSignal): Promise<ListAvailableTopicsTaughtReturn>
  listTeachersForTopicTaught(args: ListTeachersForTopicTaughtArgs, headers?: object, signal?: AbortSignal): Promise<ListTeachersForTopicTaughtReturn>
  listTopicsTaughtOfTeacher(args: ListTopicsTaughtOfTeacherArgs, headers?: object, signal?: AbortSignal): Promise<ListTopicsTaughtOfTeacherReturn>
  listTeacherAvailabilities(args: ListTeacherAvailabilitiesArgs, headers?: object, signal?: AbortSignal): Promise<ListTeacherAvailabilitiesReturn>
...
export interface ListAvailableTopicsTaughtArgs {
}

export interface ListAvailableTopicsTaughtReturn {
  topicsTaught: Array<TopicTaught>  
}
export interface ListTeachersForTopicTaughtArgs {
  lang: string
  topic: string
}

export interface ListTeachersForTopicTaughtReturn {
  teachers: Array<Teacher>  
}
export interface ListTopicsTaughtOfTeacherArgs {
  teacherId: string
}

export interface ListTopicsTaughtOfTeacherReturn {
  topicsTaught: Array<TopicTaught>  
}
export interface ListTeacherAvailabilitiesArgs {
  teacherId: string
}

export interface ListTeacherAvailabilitiesReturn {
  timeSlots: Array<TimeSlot>  
}
...
export class TeacherServiceAPI implements TeacherServiceAPI {
  ...
  listTopicsTaught = (headers?: object, signal?: AbortSignal): Promise<ListTopicsTaughtReturn> => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          topicsTaught: <Array<TopicTaught>>(_data.topicsTaught),
        }
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error.message || ''}` })
  ...
  teach = (args: TeachArgs, headers?: object, signal?: AbortSignal): Promise<TeachReturn> => {
    return this.fetch(
      ...
      return buildResponse(res).then(_data => {
        return {
          topicTaught: <TopicTaught>(_data.topicTaught),
        }
      })
    }, (error) => {
      throw WebrpcRequestFailedError.new({ cause: `fetch(): ${error.message || ''}` })
...
export class ClassServiceAPI implements ClassServiceAPI {
  ...
  listAvailableTopicsTaught = (headers?: object, signal?: AbortSignal): Promise<ListAvailableTopicsTaughtReturn> => {
    return this.fetch(
      this.url('ListAvailableTopicsTaught'),
      createHTTPRequest({}, headers, signal)
      ).then((res) => {
      return buildResponse(res).then(_data => {
        return {
  ...
  listTeachersForTopicTaught = (args: ListTeachersForTopicTaughtArgs, headers?: object, signal?: AbortSignal): Promise<ListTeachersForTopicTaughtReturn> => {
    return this.fetch(
      this.url('ListTeachersForTopicTaught'),
      createHTTPRequest(args, headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          teachers: <Array<Teacher>>(_data.teachers),
  ...
  listTopicsTaughtOfTeacher = (args: ListTopicsTaughtOfTeacherArgs, headers?: object, signal?: AbortSignal): Promise<ListTopicsTaughtOfTeacherReturn> => {
    return this.fetch(
      this.url('ListTopicsTaughtOfTeacher'),
      createHTTPRequest(args, headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          topicsTaught: <Array<TopicTaught>>(_data.topicsTaught),
  ...
  listTeacherAvailabilities = (args: ListTeacherAvailabilitiesArgs, headers?: object, signal?: AbortSignal): Promise<ListTeacherAvailabilitiesReturn> => {
    return this.fetch(
      this.url('ListTeacherAvailabilities'),
      createHTTPRequest(args, headers, signal)).then((res) => {
      return buildResponse(res).then(_data => {
        return {
          timeSlots: <Array<TimeSlot>>(_data.timeSlots),
