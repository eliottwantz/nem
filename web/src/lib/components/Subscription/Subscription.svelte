		...
		>
			...
			<div class="flex items-center justify-center gap-x-2">
				<span>
					...
					{:else if i === 2}
						<img class="h-8 w-8 sm:h-12 sm:w-12" src="/airplane.svg" alt="Airplane" />
					{:else if i === 3}
			...
			{#if i === 2}
				<button class="variant-filled-primary btn">Subscribe</button>
			{:else if i === 4}
				<button class="variant-outline-primary btn ring-2">Subscribe</button>
			{:else}
				<button class="variant-outline-primary btn ring-2">Subscribe</button>
			{/if}
		</div>
